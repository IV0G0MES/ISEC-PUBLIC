const InfoComponent = (props) => {
  //console.log(props);  Serve para ver na console exatamente os props que estamos a receber
  return (
...
root.render(
  <React.StrictMode>
    ...
    <InfoComponent title="Vue" src="vue.png" url="https://vuejs.org/">
      ...
      top of standard HTML, CSS and JavaScript, and provides a declarative and
      component-based programming model that helps you efficiently develop user
      interfaces, be it simple or complex.{" "}
    </InfoComponent>
  </React.StrictMode>
);
