package pt.isec.a2019143183.ficha_introd.ex19.ui;


import pt.isec.a2019143183.ficha_introd.ex19.model.Book;
    ...
    void addBook() {
        ...
        int id=switch (type){
            ...
            case 2->{
                ...
                yield lib.addRecentBook(title,authors,isbn,price);
            }
            default -> -1;
        };
        if (id<0)
        ...
        while (true) {
            switch (PAInput.chooseOption("LibraryList Manager - "+lib.getName(),
                ...
                case 6:
                    ...
                    System.out.println("toStringSorted: ");
